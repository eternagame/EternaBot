...
class Strategy(strategy_template.Strategy):
    def __init__(self):
        ...
        self.default_params_ = [10,4,6,0.45,0.65,0.4,0.5,0.05,10, 0.05, 0]
    ...
    def score(self, design, params):            
        ...
        for state in states:
            ...
            #params[6]: 50% ua
            #params[7]: 5%  gu
            total_pairs = design[n]['default']['gu'] + design[n]['default']['gc'] + design[n]['default']['ua']
            gcPercentage = float(design[n]['default']['gc'])/total_pairs
            uaPercentage = float(design[n]['default']['ua'])/total_pairs
            guPercentage = float(design[n]['default']['gu'])/total_pairs
