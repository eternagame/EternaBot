...
class Strategy(strategy_template.Strategy):
    def __init__(self):
        ...
        self.title_ = ("[Strategy Market] [Switch]"
                       "How MicroRNA likes to bind: Turn on labs")
        ...
        self.default_params_ = [1, 0.5, -1, -0.5, 0.05, 0]
    ...
    def score(self, design, params):
        ...
        # Turn on labs
        if (design['type'] == "miRNA" and
                "turn-off" not in design['puztitle']):
