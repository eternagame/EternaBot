...
class OligoPuzzle:
    ...
    def get_design_score(self, sequence, secstruct):
        ...
        try:
            ...
            # print "Scoring seq", design['sequence']
            # print "Scoring secstruct1", design['state1']['default']['secstruct']
            # print "Scoring secstruct2", design['state2']['default']['secstruct']
    ...
    def score_secstructs(self, secstruct, energies = False, sequence = False):
        ...
        if energies and energies[1] != '' and energies[0] != '' and float(energies[1]) - 4.00322 > float(energies[0]):
            distance += 4
