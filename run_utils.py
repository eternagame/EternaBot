...
def run_strategy(strategy,designs,op):
	...
	if(op == "PUBLISH" and strategy.publishable_):
		...
		body = {'title':strategy.title_, 'author':strategy.author_, 'url':strategy.url_, 'ktcorr':'%.3f' % final_kt_corr, 'body':body_data, 'codelen':strategy.code_length_ , 'type':"strategy",  'workbranch':"jee"}
